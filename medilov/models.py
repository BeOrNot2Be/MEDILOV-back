...
class Gallery(models.Model):
    ...
    topic = models.ForeignKey(GalleryTopic, models.DO_NOTHING, null=True, blank=True, related_name='galleries')
...
class Photo(models.Model):
    ...
    date = models.DateTimeField('last update', auto_now=True)
    gallery = models.ForeignKey(Gallery, models.DO_NOTHING, null=True, blank=True, related_name='photos')
...
class Service(models.Model):
    ...
    long_description = models.CharField('long service description', max_length=5000)
